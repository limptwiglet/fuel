/**
 * Fuel build functions for creating a packaged Ember.js file
 *
 * TODO:
 *	- Include underscore as a dependancy
 */
 ...
 *
 * TODO:
 * - Arguments should be passed in a config object
 *   {
 *		path: '' || __dirname, Path to build
 *		exclude: 'html|test', Files to exclude
 *		watch: true | false, Should file be watched
